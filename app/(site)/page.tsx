...
<section className="w-full">
      <div className="container-fluid mx-auto">
        <div className="relative w-full">
         ...
         <h3 className="text-[9px] bg-[#fff] text-black text-center w-[55%] rounded-[20px]"> Transform your workplace and community</h3>
  ...
  <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
    ...
    <div className="flex p-[105px] pb-[180px] flex-col md:flex-row h-full bg-cover bg-center bg-[url('/28.png')]">
  ...
  <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
    ...
    <div className='w-[80%] mt-[-130px] mx-auto flex flex-col md:flex-row border border-black border-solid'>
    <div className=' flex flex-col md:flex-row w-6/12 bg-white '>
          <div className='w-6/12 bg-[url("/30.png")] bg-cover h-full bg-bottom  w-[256px] h-[313px] top-[1785px] left-[100px] gap-0 border-t border-transparent '>

              </div>
              <div className='w-6/12 pl-[14px] grid justify-center leading-44 p-[49px]'>
    ...
    <div className="container w-[89%] mx-auto pt-[100px] pb-[100px]">
      ...
      <div className=" pl-[14px] flex items-center p-[23px] justify-end mt-[-120px]">
      ...
      <div className=" pl-[14px] flex items-center p-[23px]  mt-[-120px]">
      <div className="w-4/12 flex items-center justify-center"> <div className="w-6/12 p-2" >
      <img src="/34.png" alt="" className='' />
        ...
        <div className="flex flex-col md:flex-row w-[89%] mx-auto items-center rounded-[5px]" style={{ backgroundColor: 'rgb(3, 4, 2)' }}>
          ...
          <h3 className="text-[15px] bg-[#fff] text-black font-bold text-center w-[45%] rounded-[20px]">About the Book</h3>
            <h5 className="text-[35px] text-[#A1CF5F]   pb-[15px] font-bold pt-[20px]">THE INTERSECTION</h5>
...
<section className="flex w-[97%] mt-[54px] mx-auto  items-center justify-center gap-9 bg-[#000]">
    ...
    <div className="flex">
      ...
      <p className="absolute top-2 left-[12%] text-white z-max bg-black px-2 py-0 rounded-full text-sm">5 Sep 2024</p>
...
<div className=" flex w-[89%] mx-auto bg-[#000000] p-5">
