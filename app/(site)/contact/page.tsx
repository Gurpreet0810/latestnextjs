...
export default function Book() {
    return (
        <main className="md:w-[95%]   mx-auto   ">
            ...
            <p className="font-normal text-[18px] text-center md:text-left  float-left  text-black  p-2 pb-3">
            ...
            <img src='/97.png' className="w-[65%] mx-auto md:mx-0 p-2 md:p-0" alt=" " />
            </div>
            </section>
            {/* </div>

        <section className="container mx-auto md:mt-[-8%]"> */}
        <div className=" md:flex mx-auto bg-[#F7F7F7] md:mt-[-4%] pt-20">
                ...
                <section className="container mx-auto pb-15">
                    <div className="md:flex">
                        ...
                        <h2 className="font-bold text-black  mx-auto text-center    md:text-[40px] text-[25px] leading-tight mb-4">Discover Our Latest Release – A Must-Read for Changemakers!</h2> 
                          <p className="text-[#000000]   mx-auto text-center ">For decades now, I have witnessed the near non-existence of the  practical intersection between faith and work.</p> 
                ...
                <div className="container mx-auto" >  <section className="pb-15 pt-[50px] border border-x-0 border-y-stroke bg-alabaster py-11 dark:border-y-strokedark dark:bg-black">
                      ...
                      <div className="md:flex flex-wrap justify-center gap-2 w-[63%] mx-auto pt-[29px] ">
  ...
  <div className="relative bg-black text-white p-[27px] w-[150px] h-[150px] md:flex items-center justify-center mx-auto">
    <div className="text-left md:absolute bottom-[15px] w-[89%]">
