        ...
        <main className="md:w-[91%] mx-auto"> 
                ...
                <section className="md:flex md:py-[32px] ">
                      ...
                      <hr />  
                                ...
                                <div className="md:w-1/3 grid justify-end p-10">
                                <img src="/57.png" alt="" />
                                  </div>
             </section>
            ...
            <section className="bg-[#F5F5F5] p-[34px]  md:pt-[0px]">
                    ...
                    <div className="md:w-[60%] md:pl-10 md:pr-10 md:pt-0 pt-20 relative">
                      ...
                      <div className="md:flex ">
                        ...
                        <img src='78.png'   />
                        <h5 className="text-black text-[18px]">Awaken believers to their part in God's story</h5>
                        </div>
                        <div className="md:w-1/3 p-10 grid gap-10">
                        <img src='79.png'   />
                        <h5 className="text-black text-[18px]">Equip them to better live out their purpose</h5>
                        </div>
                        <div className="md:w-1/3 p-10 grid gap-10">
                        <img src='80.png'   />
                        <h5 className="text-black text-[18px]">Unleash them to create lasting transformation in their cities</h5>
                        </div>
                        
                      </div><img src='/81.png' alt="" className="md:absolute hidden md:block left-[-6%] top-[13%]" />
                    </div>
                    </div>
                    <div className=""><h3 className=" md:w-1/3 text-black font-normal">
          ...
          <section className="md:flex w-[80%] mx-auto pb-[100px]">
            ...
            <h4 className={` text-[15px] font-normal   text-[#000000] `}> When we talk about leaders creating impact within their sphere of  society, we’re talking about creating cultural transformation, built on  justice, love, shalom, and other biblical principles.
            </h4>
